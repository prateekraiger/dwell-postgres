            ...
            <main className="flex-grow flex flex-col items-center justify-center relative z-10">
                ...
                <div className="mt-8 flex justify-center">
                    {buttonLink ? (
                        <Link
                            href={buttonLink}
                            ref={targetRef as React.RefObject<HTMLAnchorElement>}
                            className="py-2 px-4 rounded-xl border border-foreground/50 hover:border-foreground/80 text-foreground transition-colors focus:outline-none focus:ring-2 focus:ring-ring inline-block"
                        >
                            {buttonText}
                        </Link>
                    ) : (
